...
namespace Medo.Modules.TextEditorModule.ViewModels
{
    class ViewTextEditorModuleViewModel : BindableBase
    {
        ...
        TextInlineSelection textSelection = new TextInlineSelection();

        public ViewTextEditorModuleViewModel(IEventAggregator eventAggregator)
        {
            this._eventAggregator = eventAggregator;
            textSelection.PropertyChanged += TextSelection_PropertyChanged;
            //AsyncLoad();
        }
        private void TextSelection_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            OnPropertyChanged("textSelection." + e.PropertyName);
        }
